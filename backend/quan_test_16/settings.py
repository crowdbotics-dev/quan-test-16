"""
Django settings for quan_test_16 project.
...
ROOT_URLCONF = 'quan_test_16.urls'
...
WSGI_APPLICATION = 'quan_test_16.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quan_test_16 API",
    "DESCRIPTION": "API documentation for quan_test_16 App",
    "VERSION": "v1",
}
